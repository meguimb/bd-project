...
AS
SELECT produto.ean, categoria.nome, EXTRACT(QUARTER FROM “timestamps”), EXTRACT(DAY FROM “timestamps”), 
EXTRACT(DOW FROM “timestamps”), pr.distrito, pr.concelho, er.unidades
FROM produto
